    ...
    */
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", (event) => {
            ...
            let providedUsername = usernameInput.val();
            if (!providedUsername) {
            ...
            let providedPassword = passwordInput.val();
            if (!providedPassword) {
    ...
    if (signupForm) {
        signupForm.addEventListener("submit", (event) => {
            ...
            let providedPassword2 = password2Input.val();
    ...
    if (searchForm) {
        searchForm.addEventListener("submit", (event) => {
            ...
            if (trimmedSearchTerm == "") {
                errorOnPage("Search term connot be empty");
                return false;
            }
